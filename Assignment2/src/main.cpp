...
int main(int argc, char** argv)
{
    ...
    std::vector<glm::vec3> ball_bcurve_track_points = {glm::vec3(1.0f,1.0f,23.0f), glm::vec3(0.0f,0.0f,20.0f), glm::vec3(-2.0f,0.0f,5.0f), glm::vec3(-2.0f,0.0f,-8.0f), glm::vec3(0.0f,0.0f,-20.0f)};
    ...
    vector<glm::vec3> pinPos { glm::vec3(0.0f,0.05f,-18.0f),
        glm::vec3(),glm::vec3(),glm::vec3(),
        glm::vec3(),glm::vec3(),glm::vec3(),
        glm::vec3(),glm::vec3(),glm::vec3()};

    Pins pin(std::string("../models/obj/pin.obj"),&ourShader,time_to_fall);
